...
export const handler = async (event, context) => {
  ...
  const signupOptions = {
    ...
    handler: async ({ username, hashedPassword, salt, userAttributes }) => {
      ...
      //   },
      // })
      // here, create a user, then add their roles, then return the user (with the roles)
      ...
      console.log(noRoleUser)

      const userRoles = await db.userRole.create({
        data: {
      ...
      return { ...noRoleUser, roles: [userAttributes.role] }
